...
from ..utils import create_model, _MODEL_INFO, image_transform
from ..training.main import convert_models_to_fp32, convert_weights
from .benchmark_utils import track_infer_time, print_timings
...
if __name__ == '__main__':
    ...
    text = torch.vstack([tokenize(["杰尼龟"], context_length=args.context_length)] * args.batch_size)
    if args.device == "cuda":
        image = image.cuda()
        text = text.cuda()
