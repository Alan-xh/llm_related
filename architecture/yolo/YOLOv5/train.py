"""Train the YOLOv5 teaching model on synthetic rectangles."""
...
try:
    ...
    from architecture.yolo.YOLOv5.model import build_model
...
def main() -> None:
    ...
    parser.add_argument("--checkpoint", default="yolov5_tiny.pt")
