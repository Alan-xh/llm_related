"""Train the YOLOv10 teaching model with a dual-head objective."""
...
try:
    ...
    from architecture.yolo.YOLOv10.model import build_model
...
def main() -> None:
    ...
    parser.add_argument("--checkpoint", default="yolov10_tiny.pt")
