"""Train the YOLOv4 teaching model on synthetic rectangles."""
...
try:
    ...
    from architecture.yolo.YOLOv4.model import build_model
...
def main() -> None:
    ...
    parser.add_argument("--checkpoint", default="yolov4_tiny.pt")
