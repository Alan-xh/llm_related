...
def main() -> None:
    """解析命令行参数并运行 Kimi K2 风格的缓存生成。"""
    parser = argparse.ArgumentParser(description="使用 Kimi K2 风格的最小模型生成文本。")
    parser.add_argument("--prompt", default="Explain why MLA reduces KV-cache pressure.")
